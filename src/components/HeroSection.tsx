...
const FloatingContacts = () => {
  ...
  const handleWhatsAppClick = () => {
    ...
    const message =
      "Hi! I'm interested in OPSC preparation courses from Odisha Preps.";
...
const HeroSection = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      const randomColor = new THREE.Color().lerpColors(
        color1,
        color3,
        Math.random()
      );
  ...
  return (
    ...
    >
      ...
      <div id="home" className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center py-12 md:py-20">
        ...
        <p
          className="text-xl sm:text-2xl md:text-3xl text-yellow-400 font-semibold mb-8 animate-fade-in"
        ...
        <p className="text-md md:text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed mb-12 animate-fade-in">
          The platform that has become the one stop solution for mastering the
          evolving demands of the OPSC OCS exam with deep, analytical insights.
          Backed by supreme content, we’re the most comprehensive and affordable
          platform aiming to transform way to prepare for Odisha civil service
          examination.
        </p>
        ...
        <div className="bg-gray-900/40 backdrop-blur-md border border-gray-700/50 rounded-2xl p-6 sm:p-8 w-full max-w-3xl mb-12 animate-fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
              onClick={handleWhatsAppClick}
              className="w-full bg-green-600/90 hover:bg-green-600 text-white h-16 rounded-xl shadow-lg hover:shadow-green-500/40 transition-all duration-300 flex items-center justify-center px-4 space-x-3 text-md font-semibold hover:scale-105 transform"
            >
              <img
                src={whatsappIcon}
                alt="WhatsApp"
            ...
            <button
              onClick={handlePhoneClick}
              className="w-full bg-blue-600/90 hover:bg-blue-600 text-white h-16 rounded-xl shadow-lg hover:shadow-blue-500/40 transition-all duration-300 flex items-center justify-center px-4 space-x-3 text-md font-semibold hover:scale-105 transform"
            >
              <img
                src={phoneIcon}
                alt="Phone"
            ...
            <button
              onClick={handleTelegramClick}
              className="w-full bg-sky-500/90 hover:bg-sky-600 text-white h-16 rounded-xl shadow-lg hover:shadow-sky-500/40 transition-all duration-300 flex items-center justify-center px-4 space-x-3 text-md font-semibold hover:scale-105 transform"
            >
              <img
                src={telegramIcon}
                alt="Telegram"
        ...
        <div
          ...
          onClick={() =>
            window.open(
              "https://youtube.com/playlist?list=PLp1pMnEljrbLL7cAns4iRZztGm6YcchFE&si=6B3iZnJSFnT8Uq34",
              "_blank"
            )
          }
        >
          <img
            src={giftIcon}
            alt="Free Resources"
            className="w-24 h-24 md:w-28 md:h-28 mb-2 transform group-hover:scale-110 transition-transform duration-300"
          />
